...
local StaticAutomation = (function()
	local api = {}
	local enabled = false
	local toggle = nil
	local promptCount = 0
...
_G.StaticAutomation = StaticAutomation
if getgenv then
	getgenv().StaticAutomation = StaticAutomation
end

return { name = "static", StaticAutomation = StaticAutomation }
