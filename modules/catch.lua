...
local CatchAutomation = (function()
	local api = {}
...
_G.CatchAutomation = CatchAutomation
if getgenv then
	getgenv().CatchAutomation = CatchAutomation
end

return { name = "catch", CatchAutomation = CatchAutomation }
